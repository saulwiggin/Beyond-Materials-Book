...
for n=1:namx
    ...
    %Ez field update
    Ezx(2:ie,2:je) = ca(Ezx(2:ie,2:je).*Ezx(2:ie,2:je) + cbEzx(2:ie,2:js).*(Hy(2:ie,2:je) - Hy(1:ie-1,2:je));
    Ezy(2:ie,2:je) = caEzsy(2:ie,2:je).*Ezy(2:ie,2:je) + cbEzy(2:ie,2:je).*(Hx(2:ie,1:je-1) - Hx(2:ie,2:je));
